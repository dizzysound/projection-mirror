...
class Delegate(NSObject):
    ...
    def _mirror(self, ips, letterbox, mon):
        ...
        try:
            ...
            # Always release the App Nap assertion and reset UI state, even if stop() raises -
            # otherwise nap stays disabled for the process lifetime and the GUI hangs on "MIRRORING".
            self._end_activity()
