...
def _parse_602(data):
    """Field offsets confirmed against data/captures-2026-09-08/wake194-discovery.pcap."""
...
# live A/B on .194, so the mechanism is sound and the cadence was the lever. Match the vendor at 0.5 s.
